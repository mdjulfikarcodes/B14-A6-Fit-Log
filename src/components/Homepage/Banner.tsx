...
const Banner = () => {
    return (
        <section className={`px-4 py-6 sm:px-6 md:px-8 lg:px-10 lg:py-10`}>
            <div className="mx-auto px-7 py-15 flex flex-col overflow-hidden rounded-2xl border border-[#292d35] bg-[#15171e] lg:min-h-100.00 lg:flex-row">
                ...
                <div className="flex w-full flex-col justify-center px-6 py-10 sm:px-8 md:px-10 lg:w-[60%] lg:px-12 lg:py-12">
                    ...
                    {/* Main Heading */}
                    <h1
                        className={`max-w-2xl text-[42px] uppercase leading-[0.92] text-white sm:text-[50px] md:text-[56px] lg:text-[60px] xl:text-[64px]`}
                    >
