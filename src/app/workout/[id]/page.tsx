                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="mt-5 flex flex-wrap gap-2">
                            ...
                            <button
                                ...
                                className="rounded-md bg-[#b6ff00] px-4 py-2 text-[10px] font-bold text-black transition hover:bg-[#c5ff33]"
                            ...
                            <button
                                ...
                                className="rounded-md border border-[#30343d] bg-transparent px-4 py-2 text-[10px] font-medium text-gray-300 transition hover:bg-[#181b22]"
