...
const WorkoutDetailsPage = async ({
  ...
  return (
    <main className="bg-[#0d0f13] px-4 py-6 text-white md:px-6 lg:px-8">
      <div className="mx-auto w-full max-w-7xl overflow-hidden rounded-lg border border-none bg-[#0f1116]">
